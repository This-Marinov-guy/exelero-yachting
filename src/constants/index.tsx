...
export const FusoCarRental: string = "Exelero car rental";
...
export const WorldBestCompanies: string = "World best companies are hiring on hire up";
...
export const CompanyTitle: string = "World best companies are hiring on hire up";
export const Filters: string = "Filters";
export const NotFoundContent:string ="There are no products that meet your criteria. To improve your search, please try different filters.";
...
export const CarFeaturesTitle :string = "Features";
...
export const BreadCrumbListTitle :string = "Business Development";
...
export const FurnishingDetail: string = "Furnishing Detail";
export const Area: string = "Area";
export const PropertyFeatures: string = "Property Features";
...
export const JobApplyBannerTitle: string = "Job Applied";
...
export const Lead: string = "Lead,United Kingdom";
...
export const content404: string = "We couldn't find the page you're looking for. It's possible that the link you clicked on is broken or the page has been moved.";
export const NotFoundTitle: string = "Page Not Found";
export const GoBack: string = "Go To Home Page";
export const LogIn: string = "Log In";
export const Welcome: string = "Welcome To Exelero";
...
export const LogInWithGoogle: string = "Log In With Google";
export const LogInWithFacebook: string = "Log In With Facebook";
export const NotAccount: string = "Don`t have an account?";
export const FindPlace: string = "Find a Place you will Love.";
export const DiscoveryPlace: string = "Discover your perfect place with ease. Whether you’re searching for a dream home, a cozy vacation rental, or a workspace, we connect you with locations that fit your lifestyle.";
export const SignUpAccount: string = "Sign Up Account";
export const ConditionAccept: string = "I understand and accept the";
export const Terms: string = "Terms and Conditions";
export const PrivacyPolicy: string = "Privacy Policy";
export const CreateAnAccount: string = "Create An Account";
export const AlreadyAnAccount: string = "Already have an Account?";
export const DragDrop: string = "Click to upload, or drop files here.";
export const MoreFileAdd: string = "Click or drag more files to add";
export const FileTitle: string = "File";
