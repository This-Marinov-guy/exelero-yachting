...
const Car3RightGridContainer = () => {
  return (
    <>
      ...
      <GridView type={"car"} sectionClass='car-shop-section car-product-section' filterClass='filter-sidebar' side="right" gridSize={3} cardShow={9} tagClass='car-list-header' />
    </>
  );
};
